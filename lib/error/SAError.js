...
function SAError (properties) {
  ...
  if (this.originalError && this.originalError.summary) {
    this.reason = this.originalError.summary
  } else {
  ...
  //     this.invalidAttributes = R.map((key, value) => {
  //       return R.map(i => {

  //       }, value)
  //     }, this.originalError.invalidAttributes)

  //     R.forEach(n => {
  //       this.invalidAttributes[n] = R.map(i => {
  //         if (R.has(i.rule, errors[n])) {
  //           i.message = errors[n][i.rule]
  //         }

  //         return R.pick(['message'], i)
  //       })
  //     })
  //   }
  // }
