 ...
 */
module.exports.create = function create (roles, models, config, pRoutes) {
  // return Promise.all([
  return grantRootPermissions(roles, models, config, pRoutes)
...
function grantRootPermissions (roles, controllers, config, pRoutes) {
